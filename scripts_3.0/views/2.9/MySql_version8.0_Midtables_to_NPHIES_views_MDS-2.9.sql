...
SET @supporting_query = 'CREATE OR REPLACE VIEW NPHIES_CLAIMSUPPORTINGINFO (PROVCLAIMNO, SEQUENCENO, CATEGORY, REASON,
		...
		FROM (
			SELECT WG.PROVCLAIMNO AS PROVCLAIMNO, NULL AS SEQUENCENO, "temperature" AS SUPPORTTYPE, NULL,
		...
		UNION ALL
            SELECT PROVCLAIMNO AS PROVCLAIMNO, NULL AS SEQUENCENO, "patient-history", NULL, MAINSYMPTOM AS SUPPORTINGVALUE, NULL, NULL, NULL, NULL, NULL, NULL
            FROM WSL_GENINFO WHERE MAINSYMPTOM IS NOT NULL
        UNION ALL
            SELECT PROVCLAIMNO AS PROVCLAIMNO, NULL AS SEQUENCENO, "history-of-present-illness", NULL, MAINSYMPTOM AS SUPPORTINGVALUE, NULL, NULL, NULL, NULL, NULL, NULL
            FROM WSL_GENINFO WHERE MAINSYMPTOM IS NOT NULL
        UNION ALL
            SELECT WSG.PROVCLAIMNO AS PROVCLAIMNO, NULL AS SEQUENCENO, "treatment-plan", NULL,
		...
		UNION ALL
			SELECT WG.PROVCLAIMNO AS PROVCLAIMNO, NULL AS SEQUENCENO, "vital-sign-weight" AS SUPPORTTYPE, NULL,
		...
		UNION ALL
            ...
            SELECT WG.PROVCLAIMNO AS PROVCLAIMNO, NULL AS SEQUENCENO, "vital-sign-height", "999.9", NULL, NULL, NULL, NULL, NULL,
        ...
        UNION ALL
            -- TIMINGPERIODFROM - min (serviceDate from service_details)
            SELECT WG.PROVCLAIMNO AS PROVCLAIMNO, NULL AS SEQUENCENO, "oxygen-saturation", "999", NULL, NULL, NULL, NULL, NULL,
            NPS.SERVICEDATE AS TIMINGPERIODFROM, NULL
            FROM WSL_GENINFO WG JOIN NPHIES_PROVCLAIMNO_SERVICEDATE NPS ON NPS.PROVCLAIMNO = WG.PROVCLAIMNO
		UNION ALL
		...
		UNION ALL
            ...
            SELECT PROVCLAIMNO AS PROVCLAIMNO, NULL AS SEQUENCENO, "physical-examination" AS SUPPORTTYPE, NULL, CONVERT(SIGNIFICANTSIGN, CHAR), NULL AS FILECONTENT,
             NULL, NULL, NULL, NULL, NULL FROM WSL_GENINFO
        UNION ALL
			SELECT WG.PROVCLAIMNO AS PROVCLAIMNO, NULL AS SEQUENCENO, "pulse" AS SUPPORTTYPE, NULL, CONVERT(PULSE, CHAR) AS SUPPORTINGVALUE, NULL AS FILECONTENT,
            NULL AS FILENAME, NULL AS ATTACHMENTTYPE, "/min" AS CODE,  NPS.SERVICEDATE AS TIMINGPERIODFROM, NULL AS TIMINGPERIODTO
            FROM WSL_GENINFO WG JOIN NPHIES_PROVCLAIMNO_SERVICEDATE NPS ON NPS.PROVCLAIMNO = WG.PROVCLAIMNO WHERE PULSE IS NOT NULL
		UNION ALL
			SELECT WG.PROVCLAIMNO AS PROVCLAIMNO, NULL AS SEQUENCENO, "respiratory-rate" AS SUPPORTTYPE, NULL, CONVERT(RESPIRATORYRATE, CHAR) AS SUPPORTINGVALUE,
		...
		UNION ALL
			SELECT WG.PROVCLAIMNO AS PROVCLAIMNO, NULL AS SEQUENCENO, "vital-sign-systolic" AS SUPPORTTYPE, NULL, CONVERT(BLOODPRESSURE, CHAR) AS SUPPORTINGVALUE,
		...
		UNION ALL
			SELECT WG.PROVCLAIMNO AS PROVCLAIMNO, NULL AS SEQUENCENO, "vital-sign-diastolic" AS SUPPORTTYPE, NULL, CONVERT(BLOODPRESSURE, CHAR) AS SUPPORTINGVALUE,
		...
		UNION ALL
			...
			END AS SUPPORTINGVALUE, NULL AS FILECONTENT, NULL AS FILENAME, NULL AS ATTACHMENTTYPE, CODE_temp AS CODE, NPS.SERVICEDATE AS TIMINGPERIODFROM, NULL AS TIMINGPERIODTO
			from (
...
SET @supporting_query = 'CREATE OR REPLACE VIEW NPHIES_CLAIMSUPPORTINGINFO (PROVCLAIMNO, SEQUENCENO, CATEGORY, REASON,
		...
		UNION ALL 
			...
			FROM WSL_GENINFO WHERE MAINSYMPTOM IS NOT NULL AND MAINSYMPTOM != ''
        UNION ALL
            SELECT PROVCLAIMNO AS PROVCLAIMNO, NULL AS SEQUENCENO, "patient-history", NULL, MAINSYMPTOM AS SUPPORTINGVALUE, NULL, NULL, NULL, NULL, NULL, NULL,NULL
            FROM WSL_GENINFO WHERE MAINSYMPTOM IS NOT NULL
        UNION ALL
            SELECT PROVCLAIMNO AS PROVCLAIMNO, NULL AS SEQUENCENO, "history-of-present-illness", NULL, MAINSYMPTOM AS SUPPORTINGVALUE, NULL, NULL, NULL, NULL, NULL, NULL,NULL
            FROM WSL_GENINFO WHERE MAINSYMPTOM IS NOT NULL
        UNION ALL
            SELECT WSG.PROVCLAIMNO AS PROVCLAIMNO, NULL AS SEQUENCENO, "treatment-plan", NULL,
            (SELECT GROUP_CONCAT(concat_ws(" - ", WSD.SERVICECODE, WSD.SERVICEDESC) ORDER BY WSD.SERVICECODE ASC SEPARATOR ", ")
		...
		UNION ALL
            -- significantsign - physical examnation
            SELECT PROVCLAIMNO AS PROVCLAIMNO, NULL AS SEQUENCENO, "physical-examination", NULL, CONVERT(SIGNIFICANTSIGN, CHAR), NULL, NULL, NULL, NULL, NULL, NULL, NULL
		...
		UNION ALL
			...
			when LABRESULTCOMMENT_temp is not null THEN (CONCAT(''LABCODE: '', LABCOMPCODE_temp, '' ,LABDESC: '',  LABCOMPDESC_temp , '' ,LABRESULT: '', LABRESULT_temp, '' ,LABRESULTUNIT: '', LABRESULTUNIT_temp, '' ,LABRESULTCOMMENT: '', LABRESULTCOMMENT_temp, '' ,LABRESULTCDESC: '', LABRESULTDESC_temp))
			when LABRESULTDESC_temp is not null THEN (CONCAT(''LABCODE: '', LABCOMPCODE_temp, '' ,LABDESC: '',  LABCOMPDESC_temp , '' ,LABRESULT: '', LABRESULT_temp, '' ,LABRESULTUNIT: '', LABRESULTUNIT_temp, '' ,LABRESULTCOMMENT: '', LABRESULTCOMMENT_temp, '' ,LABRESULTCDESC: '', LABRESULTDESC_temp))
			END AS SUPPORTINGVALUE, NULL AS FILECONTENT, NULL AS FILENAME, NULL AS ATTACHMENTTYPE, CODE_temp AS CODE, NPS.SERVICEDATE AS TIMINGPERIODFROM, NULL AS TIMINGPERIODTO,  NULL AS UNIT
			from (
				SELECT labResult.PROVCLAIMNO AS PROVCLAIMNO_temp,labComponent.LABCOMPCODE AS LABCOMPCODE_temp, labComponent.LABCOMPDESC AS LABCOMPDESC_temp, 
				labComponent.LABRESULT AS LABRESULT_temp, labComponent.LABRESULTUNIT AS LABRESULTUNIT_temp, labComponent.LABRESULTCOMMENT AS LABRESULTCOMMENT_temp, labResult.LABDESC AS LABRESULTDESC_temp,
				labResult.LABTESTCODE AS CODE_temp
