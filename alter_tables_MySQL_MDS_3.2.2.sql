...
ALTER TABLE NPHIES_CLAIMINFO ADD COLUMN SPECIALITYREFERRALRESPONSEID VARCHAR(255) NULL, ADD COLUMN SPECIALITYREFERRALOFFLINEID VARCHAR(255) NULL, ADD COLUMN SPECIALITYREFERRALOFFLINEDATE TIMESTAMP NULL;
