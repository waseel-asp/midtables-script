...
BEGIN
	...
	NULL AS NotNeeded_4,CODE,TIMINGPERIODFROM, TIMINGPERIODTO ,NULL
	FROM
	...
	FROM WSL_GENINFO WHERE TEMPERATURE IS NOT NULL AND TEMPERATURE != ''''
	UNION ALL 
	...
	, NULL AS NotNeeded_4, NULL As CODE, NULL AS TIMINGPERIODFROM, NULL AS TIMINGPERIODTO ,NULL
	...
	, NULL FILENAME, NULL AS NotNeeded_4, ''kg'' As CODE, NULL AS TIMINGPERIODFROM, NULL AS TIMINGPERIODTO  ,NULL
	...
	, NULL, ADMISSIONDATE AS TIMINGPERIODFROM, DISCHARGEDATE AS TIMINGPERIODTO ,NULL
	...
	, NULL FILENAME, NULL AS NotNeeded_4, NULL As CODE, NULL AS TIMINGPERIODFROM, NULL AS TIMINGPERIODTO ,NULL
	...
	, NULL AS FILECONTENT, NULL FILENAME, NULL AS NotNeeded_4, NULL As CODE, NULL AS TIMINGPERIODFROM, NULL AS TIMINGPERIODTO ,NULL
	...
	, NULL AS FILECONTENT, NULL FILENAME, NULL AS NotNeeded_4L, NULL As CODE, NULL AS TIMINGPERIODFROM, NULL AS TIMINGPERIODTO ,NULL
	...
	END AS SUPPORTINGVALUE, NULL AS FILECONTENT, NULL FILENAME, NULL AS NotNeeded_4, CODE_temp AS CODE, NULL AS TIMINGPERIODFROM, NULL AS TIMINGPERIODTO
	FROM(
	...
	UNION ALL 
	SELECT PROVCLAIMNO AS PROVCLAIMNO, ''last-menstrual-period'', NULL AS SEQUENCENO,  NULL, NULL, NULL, NULL, NULL, NULL, LASTMENSTRUATIONPERIOD AS TIMINGPERIODFROM, NULL ,NULL
	...
	, FILECONTENT , FILENAME , NULL AS NotNeeded_4, NULL As CODE, NULL AS TIMINGPERIODFROM, NULL AS TIMINGPERIODTO ,NULL
...
ELSE
	...
	FROM
	(SELECT PROVCLAIMNO AS PROVCLAIMNO, ''temperature'' As Support_Type, NULL AS SEQUENCENO,NULL As NotNeeded_1, CONVERT(NVARCHAR(max),TEMPERATURE) AS SUPPORTINGVALUE, NULL AS FILECONTENT
	, NULL FILENAME, NULL AS NotNeeded_4, ''Cel'' As CODE, NULL AS TIMINGPERIODFROM, NULL AS TIMINGPERIODTO ,NULL
	FROM WSL_GENINFO WHERE TEMPERATURE IS NOT NULL AND TEMPERATURE != ''''
	UNION ALL 
	SELECT PROVCLAIMNO AS PROVCLAIMNO, ''chief-complaint'' As Support_Type, NULL AS SEQUENCENO,NULL As NotNeeded_1, MAINSYMPTOM AS SUPPORTINGVALUE, NULL AS FILECONTENT, NULL FILENAME
	, NULL AS NotNeeded_4, NULL As CODE, NULL AS TIMINGPERIODFROM, NULL AS TIMINGPERIODTO ,NULL
	...
	when labComment_temp is not null and labComment_temp != '''' THEN (''LABCODE: '' + ISNULL(labcompcode_temp,'''') +'' ,LABDESC: '' + ISNULL(labcompdesc_temp,'''')  + '' ,LABRESULT: '' + ISNULL(labresult_temp,'''') + '' ,LABRESULTUNIT: '' + ISNULL(labunit_temp,'''') + '' ,LABRESULTCOMMENT: '' + ISNULL(labComment_temp,'''') + '' ,LABRESULTCDESC: '' + ISNULL(labresultdesc_temp,''''))
	when labresultdesc_temp is not null and labresultdesc_temp != '''' THEN (''LABCODE: '' + ISNULL(labcompcode_temp,'''') +'' ,LABDESC: '' + ISNULL(labcompdesc_temp,'''')  + '' ,LABRESULT: '' + ISNULL(labresult_temp,'''') + '' ,LABRESULTUNIT: '' + ISNULL(labunit_temp,'''') + '' ,LABRESULTCOMMENT: '' + ISNULL(labComment_temp,'''') + '' ,LABRESULTCDESC: '' + ISNULL(labresultdesc_temp,''''))
	END AS SUPPORTINGVALUE, NULL AS FILECONTENT, NULL FILENAME, NULL AS NotNeeded_4, CODE_temp AS CODE, NULL AS TIMINGPERIODFROM, NULL AS TIMINGPERIODTO ,NULL
	FROM(
	SELECT labResult.PROVCLAIMNO AS PROVCLAIMNO_temp, ''lab-test'' AS Support_Type_temp, 
		labComponent.LABCOMPCODE AS labcompcode_temp, labComponent.LABCOMPDESC AS labcompdesc_temp, labComponent.LABRESULT AS labresult_temp, 
		labComponent.LABRESULTUNIT AS labunit_temp, labComponent.LABRESULTCOMMENT AS labComment_temp,labResult.LABTESTCODE AS CODE_temp, labResult.LABDESC AS labresultdesc_temp  
